...
#define LOG_TAG "bbtservice-test"
#define LOG_NDEBUG 0
...
#if 1
    sp<IBbtManagerService> mService = interface_cast<IBbtManagerService>(sm->getService(String16("bbtmanager")));
    if ( mService == NULL) {
